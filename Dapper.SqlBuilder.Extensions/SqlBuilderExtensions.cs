...
namespace Dapper.SqlBuilder.Extensions
{
    public static class SqlBuilderExtensions
    {
        ...
        public static IEnumerable<T> Query<T>(this ISqlBuilderResult<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, bool buffered = true, int? timeOut = null)
        {
            return con.Query<T>(sqlBuilder.CommandText, sqlBuilder.CommandParameters, tran, buffered, timeOut);
        }

        public static async Task<IEnumerable<T>> QueryAsync<T>(this ISqlBuilderResult<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            return await con.QueryAsync<T>(sqlBuilder.CommandText, sqlBuilder.CommandParameters, tran, timeOut);
        }

        public static async Task<T> QuerySingleAsync<T>(this ISqlBuilderResult<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            return await con.QuerySingleAsync<T>(sqlBuilder.CommandText, sqlBuilder.CommandParameters, tran, timeOut);
        }

        public static T QuerySingleOrDefault<T>(this ISqlBuilderResult<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            return con.QuerySingleOrDefault<T>(sqlBuilder.CommandText, sqlBuilder.CommandParameters, tran, timeOut);
        }

        public static async Task<T> QuerySingleOrDefaultAsync<T>(this ISqlBuilderResult<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            return await con.QuerySingleOrDefaultAsync<T>(sqlBuilder.CommandText, sqlBuilder.CommandParameters, tran, timeOut);
        }

        public static T QueryFirstOrDefault<T>(this ISqlBuilderResult<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            return con.QueryFirstOrDefault<T>(sqlBuilder.CommandText, sqlBuilder.CommandParameters, tran, timeOut);
        }

        public static async Task<T> QueryFirstOrDefaultAsync<T>(this ISqlBuilderResult<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
        ...
        public static int QueryIdentityInt<T>(this ISqlBuilder<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            var iden = sqlBuilder.OutputIdentity();
            return con.QuerySingle<int>(iden.CommandText, iden.CommandParameters, tran, timeOut);
        }

        public static async Task<int> QueryIdentityIntAsync<T>(this ISqlBuilder<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            var iden = sqlBuilder.OutputIdentity();
            return await con.QuerySingleAsync<int>(iden.CommandText, iden.CommandParameters, tran, timeOut);
        }

        public static long QueryIdentityLong<T>(this ISqlBuilder<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            var iden = sqlBuilder.OutputIdentity();
            return con.QuerySingle<long>(iden.CommandText, iden.CommandParameters, tran, timeOut);
        }

        public static async Task<long> QueryIdentityLongAsync<T>(this ISqlBuilder<T> sqlBuilder, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            var iden = sqlBuilder.OutputIdentity();
            return await con.QuerySingleAsync<long>(iden.CommandText, iden.CommandParameters, tran, timeOut);
        }

        public static SqlMapper.GridReader QueryMultiple(this ISqlBuilder builderCollection, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
            return con.QueryMultiple(builderCollection.CommandText, builderCollection.CommandParameters, tran, timeOut);
        }

        public static async Task<SqlMapper.GridReader> QueryMultipleAsync(this ISqlBuilder builderCollection, IDbConnection con, IDbTransaction tran = null, int? timeOut = null)
        {
